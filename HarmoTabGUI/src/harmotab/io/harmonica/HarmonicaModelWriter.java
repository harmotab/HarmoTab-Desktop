...
public abstract class HarmonicaModelWriter {
	...
	public static HarmonicaModelWriter createWriter(File file) {
		return new HarmoTab3HarmonicaModelWriter(file);
	}
	
	
	
	public HarmonicaModelWriter(File file) {
		m_file = file;
	}

	public abstract void writeFile(HarmonicaModel model) throws IOException;
